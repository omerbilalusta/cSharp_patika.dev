...
namespace hazir_metotlar_datetime_math
{
    class Program
    {
        public static void Main(string[] args)
        {
            ...
            Console.WriteLine(Math.Ceiling(22.3)); //23 kendisinden büyük en küçük tam sayıyı getirir
            Console.WriteLine(Math.Round(22.3)); //22 kendisine en yakın olanı getirir
            Console.WriteLine(Math.Round(22.7)); //23
            Console.WriteLine(Math.Floor(22.7)); //22 her zaman aşağı yuvarlar
            ...
            //HackerRank https://www.hackerrank.com/challenges/30-more-exceptions/problem?h_r=profile
